...
# Output: duas *lists* nValues e tValues correspondendo a executar myFn com argumento nValues[i],
# um numTrials de vezes, que levou tValues[i] milliseconds (em média).
#
# Other optional args:
...
def tryItABunch(myFn, startN=10, endN=100, stepSize=10, numTrials=35):
    nValues = []
    tValues = []
